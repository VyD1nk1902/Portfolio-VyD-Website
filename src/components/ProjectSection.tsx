...
import { MousePointerClick, MonitorPlay } from "lucide-react";
  ...
  return (
    <section className="relative py-28 space-y-24 md:space-y-50">
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center">
          ...
          <div className="relative z-10">
            ...
            <div className="flex gap-4 p-4 text-white/60">
              <span>
      ...
      <div className="relative">
        <div
          className="pointer-events-none absolute -left-1/3 right-1/3 -top-10  -z-10 h-[650px] opacity-50 blur-3xl"
          style={{
            background:
              "radial-gradient(60% 60% at 60% 40%, rgba(125,58,242,0.65) 0%, rgba(18,8,36,0)90%)",
          }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center">
          ...
          <div className="relative md:order-2 z-10">
            ...
            <div className="flex gap-4 p-4 text-white/60 justify-end">
              <span>
                <MousePointerClick size={24} />
              </span>
              <span>
